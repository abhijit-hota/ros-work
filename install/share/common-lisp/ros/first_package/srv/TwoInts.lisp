...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_package-srv:<TwoInts-request> is deprecated: use first_package-srv:TwoInts-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <TwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name first_package-srv:<TwoInts-response> is deprecated: use first_package-srv:TwoInts-response instead.")))
